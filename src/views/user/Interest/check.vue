    ...
    <el-card shadow="nerver">
      <div class="filter-container">
        <el-form ref="searchForm" :model="searchForm" label-position="right" label-width="100px">
          <el-row :gutter="12">
            <el-col :span="6">
              <el-form-item prop="phone" label="分期表ID：">
      ...
      <el-table
        ...
        style="width: 100%;"
      >
        <el-table-column label="分期表ID" align="center" width="80">
        ...
        <el-table-column label="订单号ID" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column label="计算利息时间" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.name }}</span>
          </template>
        </el-table-column>
