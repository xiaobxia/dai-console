  ...
  <div class="app-container">
    <el-card shadow="nerver">
      <div class="filter-container">
        <el-form ref="searchForm" :model="searchForm" label-position="right" label-width="100px">
          <el-row :gutter="12">
            ...
            <el-col :span="6">
              <el-form-item prop="roles" label="操作类型：">
      ...
      >
        ...
        <el-table-column label="计息前数据" align="center">
          <el-table-column label="计息前利息" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.name }}</span>
            </template>
          </el-table-column>
          <el-table-column label="计息前违约金" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.name }}</span>
            </template>
          </el-table-column>
        ...
        <el-table-column label="订单信息" align="center">
          ...
          <el-table-column label="分期总表ID" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.name }}</span>
            </template>
          </el-table-column>
          <el-table-column label="分期计划表ID" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.name }}</span>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column label="额度情况" align="center">
          <el-table-column label="锁定额度" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.name }}</span>
            </template>
          </el-table-column>
