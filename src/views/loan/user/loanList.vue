      ...
      <div class="filter-container">
        <el-form ref="searchForm" :model="searchForm" label-position="right" label-width="100px">
          <el-row :gutter="12">
            ...
            <el-col :span="6">
              <el-form-item prop="phone" label="公司名称：">
                <el-input v-model="searchForm.phone"/>
              </el-form-item>
            </el-col>
            <el-col :span="6">
            ...
            <el-col :span="6">
              <el-form-item prop="roles" label="老用户：">
                <el-select v-model="searchForm.black" class="filter-item">
                  <el-option label="全部" value="全部"/>
                  <el-option label="是" value="是"/>
                  <el-option label="否" value="否"/>
            ...
            <el-col :span="6">
              <el-form-item prop="roles" label="白名单：">
                <el-select v-model="searchForm.black" class="filter-item">
                  <el-option label="全部" value="全部"/>
                  <el-option label="是" value="是"/>
                  <el-option label="否" value="否"/>
            ...
            <el-col :span="6">
              <el-form-item prop="roles" label="公积金：">
                <el-select v-model="searchForm.black" class="filter-item">
                  <el-option label="全部" value="全部"/>
                  <el-option label="是" value="是"/>
                  <el-option label="否" value="否"/>
            ...
            <el-col :span="6">
              <el-form-item prop="roles" label="渠道：">
                <el-select v-model="searchForm.black" class="filter-item">
                  <el-option label="全部" value="全部"/>
                  <el-option label="是" value="是"/>
                  <el-option label="否" value="否"/>
            ...
            <el-col :span="12">
              <el-form-item prop="name" label="放款时间：">
                <el-date-picker
                  v-model="searchForm.register"
                  style="width: 100%"
                  type="daterange"
